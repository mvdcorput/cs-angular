...
var t=function(){function n(){var n=this
...
n.currentPage>0&&n.currentPage--},n.prototype.range=function(n,t,a){var e=this,i=[]
n<a&&(a=n,(t=n-e.pagesGap)<0&&(t=0))
for(var s=t;s<a;s++)i.push(s)
return i},n.prototype.setPages=function(n,t){var a=this
a.pagedItems=[]
for(var e=0;e<n.length;e++)e%t==0?a.pagedItems[Math.floor(e/t)]=[n[e]]:a.pagedItems[Math.floor(e/t)].push(n[e])},n}()
n.DatatablePageModel=t}(n.directives||(n.directives={}))}(cs||(cs={}))
var cs
!function(n){!function(t){"use-strict"
var a=function(){function t(){}return t.prototype.sortData=function(n,t){var a=this,e=t.columns.filter(function(n){return n.name===t.sort.columnName})[0]
...
n.sort(a.sortDataMultipleDynamic(t.sort.direction,e,i))}else n.sort(a.sortDataDynamic(t.sort.direction,e))},t.prototype.sortDataDynamic=function(t,a){return a.dataType===n.directives.DataTableColumnType.number?function(n,e){var i=n[a.name],s=e[a.name]
return i===s?0:null===i?1:null===s?-1:"asc"===t?i-s:s-i}:a.dataType===n.directives.DataTableColumnType.string?function(n,e){var i=n[a.name],s=e[a.name]
return i===s?0:null===i?1:null===s?-1:(i=i.toLowerCase(),s=s.toLowerCase(),i<s?"asc"===t?-1:1:i>s?"asc"===t?1:-1:0)}:a.dataType===n.directives.DataTableColumnType.date?function(n,e){var i=n[a.name],s=e[a.name],o=new Date(i),l=new Date(s)
return i===s?0:null===i?1:null===s?-1:"asc"===t?o.getTime()-l.getTime():l.getTime()-o.getTime()}:void 0},t.prototype.sortDataMultipleDynamic=function(n){for(var t=[],a=1;a<arguments.length;a++)t[a-1]=arguments[a]
var e=this
return function(a,i){for(var s=0,o=0,l=t.length;0===o&&s<l;)o=0===s?e.sortDataDynamic(n,t[s])(a,i):e.sortDataDynamic("asc",t[s])(a,i),s++
return o}},t}()
t.DatatableSortModel=a}(n.directives||(n.directives={}))}(cs||(cs={}))
var cs
!function(n){!function(t){"use-strict"
var a=function(){function n(n){this.$sce=n,this.restrict="EA",this.scope={options:"=csOptions"},this.template="\n        "+e+'\n        <table ng-if="initialized === true">\n            <thead>\n                <tr>\n                    <th ng-repeat="column in options.columns">\n                        <span>{{column.title}}</span>\n                        <div class="icon-sort" \n                            ng-bind-html="svgSort"\n                            ng-click="sort(column, \'asc\')"\n                            ng-if="column.sortable && options.sort.columnName!==column.name"> \n                        </div>\n                        <div class="icon-sort" \n                            ng-bind-html="svgSortAsc"\n                            ng-click="sort(column, \'desc\')"\n                            ng-if="column.sortable && options.sort.columnName===column.name && options.sort.direction===\'asc\'"> \n                        </div>\n                        <div class="icon-sort" \n                            ng-bind-html="svgSortDesc"\n                            ng-click="sort(column, \'asc\')"\n                            ng-if="column.sortable && options.sort.columnName===column.name && options.sort.direction===\'desc\'"> \n                        </div>\n                    </th>\n                </tr>\n            </thead>\n            <tbody>\n                <tr ng-repeat="item in paging.pagedItems[paging.currentPage]"\n                    ng-class-even="\'even\'">\n                    <td ng-repeat="column in options.columns">{{item[column.name]}}</td>\n                </tr>\n            </tbody>\n            </tr>\n            </thead>\n            <tfoot>\n                <td colspan="{{options.columns.length}}">\n                    <div class="pagination">\n                        <ul>\n                            <li ng-if="paging.pagedItems.length<paging.pagesGap">\n                                <a href ng-click="paging.firstPage()" class="first" ng-bind-html="svgPagerToStart" ng-class="{disabled: paging.currentPage == 0}"></a>\n                            </li>\n                            <li>\n                                <a href ng-click="paging.prevPage()" class="prev" ng-bind-html="svgPagerBackward" ng-class="{disabled: paging.currentPage == 0}"></a>\n                            </li>\n                            <li ng-repeat="n in paging.range(paging.pagedItems.length, paging.currentPage, paging.currentPage + paging.pagesGap) "\n                                ng-class="{active: n == paging.currentPage}"\n                                ng-click="setPage()">\n                                <a href ng-bind="n + 1" class="page">1</a>\n                            </li>\n                            <li>\n                                <a href ng-click="paging.nextPage()" class="next" ng-bind-html="svgPagerForward" ng-class="{disabled: paging.currentPage == paging.pagedItems.length - 1}"></a>\n                            </li>\n                            <li ng-if="paging.pagedItems.length<paging.pagesGap">\n                                <a href ng-click="paging.lastPage()" class="last" ng-bind-html="svgPagerToEnd" ng-class="{disabled: paging.currentPage == paging.pagedItems.length - 1}"></a>\n                            </li>\n                        </ul>\n                    </div>\n                </td>\n            </tfoot>                     \n        </table>\n        '
var t=this
t.link=t.unboundLink.bind(t)}return n.prototype.unboundLink=function(n,t,a){function e(t,a){n.options.sort={columnName:t.name,direction:a},n.sorting.sortData(n.options.data,n.options),n.paging.setPages(n.options.data,n.options.paging.pageSize)}(this.initialize(n,t),n.sort=e,void 0!==n.options.sort&&null!==n.options.sort)?e(n.options.columns.filter(function(t){t.name,n.options.sort.columnName})[0],n.options.sort.direction):n.paging.setPages(n.options.data,n.options.paging.pageSize)},n.prototype.initialize=function(n,a){var e=this
a.addClass("cs-datatable"),void 0!==n.options&&null!==n.options&&(void 0!==n.options.columns&&null!==n.options.columns||(n.options.columns=[]),void 0!==n.options.data&&null!==n.options.data||(n.options.data=[]),n.svgPagerBackward=e.$sce.trustAsHtml(i),n.svgPagerForward=e.$sce.trustAsHtml(s),n.svgPagerToEnd=e.$sce.trustAsHtml(o),n.svgPagerToStart=e.$sce.trustAsHtml(l),n.svgSort=e.$sce.trustAsHtml(r),n.svgSortAsc=e.$sce.trustAsHtml(g),n.svgSortDesc=e.$sce.trustAsHtml(c),n.paging=new t.DatatablePageModel,n.sorting=new t.DatatableSortModel,n.options.paging.pageSize=5,n.setPage=function(){n.paging.currentPage=this.n},n.initialized=!0)},n}()
...
n.app.directive("csDatatable",["$sce",function(n){return new a(n)}])}(n.directives||(n.directives={}))}(cs||(cs={}))
